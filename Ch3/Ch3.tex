...
No linking between chapters, they are separate. Nor to equations outside
this chapter.
...
\caption{\label{fig-vid3}This is the caption.}

\end{figure}%

Referencing is simple, like this Figure~\ref{fig-vid3}. Such video
blocks must contain actual text (the caption is drawn from the final
line).
